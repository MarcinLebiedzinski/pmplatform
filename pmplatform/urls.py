...
urlpatterns = [
    ...
    path('pmplatform/reports/unreported_days_download_csv/<int:user_id>/<int:start_time_int>/<int:end_time_int>/', UnreportedDaysDownloadCSV.as_view(), name='unreported_days_download_csv'),
